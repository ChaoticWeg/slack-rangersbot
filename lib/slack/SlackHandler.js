...
class SlackHandler
{
    constructor()
    {
        ...
        var webhook = process.env.SlackDebug ? process.env.SlackWebhookUrl_Debug :
            process.env.SlackWebhookUrl_Release;
        
        self.slack  = new SlackWebhook(webhook, { username: process.env.SlackUsername });
    }
