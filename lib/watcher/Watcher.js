...
class Watcher extends EventEmitter
{
    ...
    handleData(data)
    {
        ...
        {
            // only check for inning change if no play has happened.
            // avoids sending the inning change message before the final play of the inning.
