...
class Watcher extends EventEmitter
{
    ...
    handleData(data)
    {
        ...
        var plays = data.liveData.plays.allPlays.filter(self.isPlayValid);

        plays.forEach(self.handlePlay);
    ...
    isPlayValid(play)
    {
        return play.about.isComplete && play.about.startTfs &&
            moment(play.about.startTfs, Timestamp.GamedayFormat).isAfter(self._lastRequestTimestamp);
    }
