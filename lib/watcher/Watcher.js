...
class Watcher extends EventEmitter
{
    ...
    start(gameId)
    {
        ...
        self._gameId = gameId;
        self._lastRequestTimestamp = Timestamp.utc();
    ...
    handleData(data)
    {
        ...
        var plays = data.liveData.plays.allPlays.filter(play => {
            return moment(play.about.startTfs, Timestamp.GamedayFormat).isAfter(self._lastRequestTimestamp);
        });
